...
class PostJobPage(BasePage):
    ...
    def select_short_term_project(self):
    ...
    def click_to_do_post_without_AI(self):
        do_post_without_AI_btn = WebDriverWait(self.driver, 10).until(
            EC.element_to_be_clickable((By.XPATH, self.DO_POST_WITHOUT_AI_XPATH))
        )
        do_post_without_AI_btn.click()

    def insert_job_post_title(self):
    ...
    def click_on_continue_to_skills(self):
    ...
    def add_required_skills_for_job(self):
    ...
    def click_to_continue_to_scope(self):
    ...
    def select_size_of_the_project(self):
    ...
    def select_the_time_of_the_project(self):
    ...
    def select_the_level_of_the_project(self):
    ...
    def click_to_continue_to_budget_section(self):
    ...
    def click_to_choose_the_fixed_price_option(self):
    ...
    def input_the_fixed_price(self):
    ...
    def click_to_continue_to_description(self):
    ...
    def click_to_continue_to_review(self):
    ...
    def click_to_post_the_job(self):
    ...
    def get_the_message_of_successfully_post(self):
    ...
    def navigate_to_my_jobs_page(self):
